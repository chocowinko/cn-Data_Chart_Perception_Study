<template>
  <div class="sunburst-highlighting">
    <h2 class="page-title">Sunburst + Highlighting (3/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h3 class="event-description">
          Highlighting Event: Highlight the <em>Spices</em> category to reveal its structure.</h3>

        <h2 class="task-title">
          Task 3: In the <em>Spices</em> category, how many specific flavors are included under the <em>Brown
          Spice</em> sub-category?</h2>
        ...
        <div class="button-control">
          <button
            class="confirm-btn"
            @click="handleConfirm(null, selectedAnswer, '/sunburst-staging-1')"
      ...
      <div class="chart-area">
        ...
        <div class="chart-wrapper">
          <iframe
            ref="chartIframe"
            src="/src/All/Sunburst_Diagram/sunburst_highlighting_3.html"
            class="chart-iframe"
            frameborder="0"
            scrolling="no"
          ></iframe>
...
const { handlePlayAnimation, handleConfirm } = useTaskTimer(
  'sunburst-highlighting-3',
  'Sunburst + Highlighting (3/3)',
)

const options = [
  { label: '(A) <em>2</em>', value: 'A' },
  { label: '(B) <em>3</em>', value: 'B' },
  { label: '(C) <em>4</em>', value: 'C' },
  { label: '(D) <em>5</em>', value: 'D' },
]
