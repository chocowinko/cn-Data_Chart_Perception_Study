<template>
  <div class="heatmap-tracing-task">
    <!-- 页面标题 -->
    <h2 class="page-title">Heatmap + Tracing (2/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          Task 2: Which city appears to have experienced more dramatic climate change over the past
          decade?
        </h2>
        ...
        <div class="button-control">
          <button
            class="confirm-btn"
            @click="handleConfirm(null, selectedAnswer, '/heatmap-tracing-3')"
...
const options = [
  {
    letter: 'A',
    value: 'A',
    text: "<em>Moscow's</em> change was more dramatic.",
  },
  {
    letter: 'B',
    value: 'B',
    text: "<em>Copenhagen's</em> change was more dramatic.",
  },
  {
    letter: 'C',
    value: 'C',
    text: 'The magnitude of change in both cities was very similar.',
  },
  {
    letter: 'D',
    value: 'D',
    text: 'The climate in both cities remained very stable, with little change.',
  },
]
