<template>
  <div class="heatmap-staging-task">
    <!-- 页面标题 -->
    <h2 class="page-title">热力图 + 分阶段 (2/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          任务2：总体而言，对于哪个城市来说，更难判断一个季节何时结束、下一个季节何时开始？
        </h2>
...
const options = [
  ...
  },
  {
    letter: 'B',
    value: 'B',
    text: '哥本哈根的季节变化更加缓慢和平稳。',
  },
  {
    letter: 'C',
    value: 'C',
    text: '两个城市的季节变化方式看起来大致相同。',
  },
  {
    letter: 'D',
    value: 'D',
    text: '对于两个城市来说，从一个季节到下一个季节的转变都非常突然。',
  },
]
