<template>
  <div class="heatmap-staging-task">
    <!-- 页面标题 -->
    <h2 class="page-title">Heatmap + Staging (2/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          Task 2: Overall, for which city is it harder to tell when one season ends and the next
          begins?
        </h2>
        ...
        <div class="button-control">
          <button
            class="confirm-btn"
            @click="handleConfirm(null, selectedAnswer, '/heatmap-staging-3')"
...
const options = [
  {
    letter: 'A',
    value: 'A',
    text: "<em>Moscow's</em> seasons change more smoothly.",
  },
  {
    letter: 'B',
    value: 'B',
    text: "<em>Copenhagen's</em> seasons change more slowly and smoothly.",
  },
  {
    letter: 'C',
    value: 'C',
    text: 'The way the seasons change looks about the same for both cities.',
  },
  {
    letter: 'D',
    value: 'D',
    text: 'For both cities, the change from one season to the next is very sudden.',
  },
]
