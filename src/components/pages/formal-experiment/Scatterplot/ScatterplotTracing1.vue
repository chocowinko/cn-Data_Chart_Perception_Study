<template>
  <div class="scatterplot-task">
    <!-- 页面标题 -->
    <h2 class="page-title">散点图 + 追踪 (1/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          任务1：当图表从2014年变化到2016年时，主要的点群移动到了哪里？
        </h2>
        ...
        <div class="button-control">
          <button
            class="confirm-btn"
            @click="
              handleConfirm(null, selectedAnswer, '/scatterplot-tracing-2')
            "
...
const options = [
  {
    letter: "A",
    value: "A",
    text: "向右上角移动（PM2.5升高，臭氧升高）",
  },
  {
    letter: "B",
    value: "B",
    text: "向左下角移动（PM2.5降低，臭氧降低）",
  },
  {
    letter: "C",
    value: "C",
