<template>
  <div class="scatterplot-task">
    <!-- 页面标题 -->
    <h2 class="page-title">Scatterplot + Tracing (1/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          Task 1: As the chart changes from 2014 to 2016, where did the main cluster of dots move
          to?
        </h2>
        ...
        <div class="button-control">
          <button
            class="confirm-btn"
            @click="handleConfirm(null, selectedAnswer, '/scatterplot-tracing-2')"
...
const { handlePlayAnimation, handleConfirm } = useTaskTimer(
  'scatterplot-tracing-1',
  'Scatterplot + Tracing (1/3)',
)
let svg = null
let g = null
let x = null
...
let margin = { top: 80, right: 100, bottom: 100, left: 100 }

const options = [
  {
    letter: 'A',
    value: 'A',
    text: 'Toward the upper right corner (higher PM2.5, higher ozone)',
  },
  {
    letter: 'B',
    value: 'B',
    text: 'Toward the lower left corner (lower PM2.5, lower ozone)',
  },
  {
    letter: 'C',
    value: 'C',
    text: 'Only the shape changed; the center of gravity did not shift',
  },
  {
    letter: 'D',
    value: 'D',
    text: 'Toward the lower right corner (higher ozone, lower PM2.5)',
  },
]
