<template>
  <div class="line-graph-task">
    <!-- 页面标题 -->
    <h2 class="page-title">Line Graph + Tracing (3/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          Task 3: From the start to the end of the year, what happened to the gap between the
...
const options = [
  {
    letter: 'A',
    value: 'A',
    text: 'This gap got smaller by the end of the year.',
  },
  {
    letter: 'B',
    value: 'B',
    text: 'This gap changed unpredictably.',
  },
  {
    letter: 'C',
    value: 'C',
    text: 'This gap stayed about the same all year.',
  },
  {
    letter: 'D',
    value: 'D',
    text: 'This gap got bigger by the end of the year.',
  },
]
