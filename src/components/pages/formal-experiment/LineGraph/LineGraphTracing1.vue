<template>
  <div class="line-graph-task">
    <!-- 页面标题 -->
    <h2 class="page-title">折线图 + 追踪 (1/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          任务1：六月份销售额最高的产品是哪个？它是否在年底前一直保持领先地位？
        </h2>
...
const options = [
  {
    letter: 'A',
    value: 'A',
    text: '六月份的销售冠军是通讯器材，并且它也是年度销售冠军。',
  },
  {
    letter: 'B',
    value: 'B',
    text: '六月份的销售冠军是日用品，并且它也是年度销售冠军。',
  },
  {
    letter: 'C',
    value: 'C',
    text: '六月份的销售冠军是通讯器材，但它不是年度销售冠军。',
  },
  {
    letter: 'D',
    value: 'D',
    text: '六月份的销售冠军是日用品，但它不是年度销售冠军。',
  },
]
