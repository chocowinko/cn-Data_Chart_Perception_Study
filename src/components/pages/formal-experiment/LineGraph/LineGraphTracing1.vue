<template>
  <div class="line-graph-task">
    <!-- 页面标题 -->
    <h2 class="page-title">Line Graph + Tracing (1/3)</h2>
    ...
    <div class="content-container">
      ...
      <div class="task-section">
        <h2 class="task-title">
          Task 1: For the month of June, which product has the highest sales? Does it stay in the
          top spot until the end of the year?
        </h2>
        ...
        <div class="button-control">
          <button
            class="confirm-btn"
            @click="handleConfirm(null, selectedAnswer, '/line-graph-tracing-2')"
...
const { handlePlayAnimation, handleConfirm } = useTaskTimer(
  'line-graph-tracing-1',
  'Line Graph + Tracing (1/3)',
)
...
const options = [
  {
    letter: 'A',
    value: 'A',
    text: 'The top seller for June was <em>Communication Equipment</em>, and it was also the top seller for the year.',
  },
  {
    letter: 'B',
    value: 'B',
    text: 'The top seller for June was <em>Daily Necessities</em>, and it was also the top seller for the year.',
  },
  {
    letter: 'C',
    value: 'C',
    text: 'The top seller for June was <em>Communication Equipment</em>, but it was not the top seller for the year.',
  },
  {
    letter: 'D',
    value: 'D',
    text: 'The top seller for June was <em>Daily Necessities</em>, but it was not the top seller for the year.',
  },
]
